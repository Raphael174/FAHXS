"""Compressible coolant mass/energy finite-volume primitives.

This module is geometry-independent. It is the next coolant model layer after
the temperature-only `coolant_fv` kernel:
...
Momentum is quasi-steady here: face mass fluxes are algebraic inputs, or can be
estimated from instantaneous pressure differences and hydraulic resistances.
"""
